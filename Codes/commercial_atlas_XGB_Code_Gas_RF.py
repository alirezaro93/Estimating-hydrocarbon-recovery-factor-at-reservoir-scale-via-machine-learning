...
plt.title('XGBoost learning curve on database CA (Gas)', fontdict={'fontsize':20})
plt.xlabel('Training set size', fontsize=20)
plt.ylabel('RMSE',fontsize=20)
plt.legend(fontsize=20)
plt.xticks(np.arange(0, len(X_train)+1, 1000), fontsize=20)
...
best_model.save_model('best_model_CA_gas_RF_XGB')
...
plt.xlabel('Measured RF',fontsize=20)
plt.ylabel('Esitmated RF',fontsize=20)
plt.title('Database CA (gas) measured RF vs estimated RF (test dataset)',fontsize=15)
...
plt.xlabel('Measured RF',fontsize=20)
plt.ylabel('Esitmated RF',fontsize=20)
plt.title('Database CA (gas) measured RF vs estimated RF (train dataset)',fontsize=15)
plt.legend(fontsize=15)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.grid(False)
...
plt.figure(figsize=(10,6))
plt.title('XGBoost model on database CA (gas RF) feature importance')
shap.summary_plot(shap_values, X_trainnum, feature_names = df_x.columns,
                  show = False)
plt.grid(False)
plt.savefig('CAXGBR_impact_on_model_output.png', bbox_inches='tight',facecolor='w')
...
bestmodel.load_model('best_model_CA_gas_RF_XGB')
...
print('')
print("independent RMSE =", rmseindependent)
print('')
print("independent R^2 =", scoreindependent)
print('')
...
plt.title('Measured RF Vs. Estimated RF (independent Dataset)')
plt.legend()
plt.grid(False)
